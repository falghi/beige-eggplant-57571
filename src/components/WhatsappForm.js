...
const WhatsappForm = (props) => {
    ...
    const waMessage = (`*${_.get(section, 'wa_message_title', null)}*%0A%0A` || '') +
    `Name: ${inpName}%0AEmail: ${inpEmail}%0AQuantity: ${inpQuantity}%0A%0A${inpMessage}`
                            ...
                            <div id={_.get(section, 'form_id', null)} className={classNames({'form-inline': form_is_inline, 'card': form_is_card, 'p-4': form_is_card, 'p-sm-5': form_is_card})}>
                                ...
                                <div className={classNames('form-content', {'flex': form_is_inline, 'flex-column': form_is_inline, 'flex-xs-row': form_is_inline})}>
                                    ...
                                    <div className={classNames('form-group', {'mb-2': form_is_inline === false, 'mb-1': form_is_inline === true, 'mb-xs-0': form_is_inline === true, 'flex-auto': form_is_inline})}>
                                        ...
                                        <input type="text" id="quantity" name="quantity" placeholder="10 kg" onChange={ (e) => {
